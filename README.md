...
Revenue Tracking: What is the total sales revenue for each month?

Location Performance: How do sales vary across different store locations (Astoria, Hell's Kitchen, and Lower Manhattan)?

Customer Behavior: What is the average price/order per person?

Inventory Insights: Which products are the best-selling in terms of quantity and revenue?

Dashboard Features & KPIs
The interactive dashboard provides a 360-degree view of the business performance:

Total Revenue: $4,815.85
Total Footfall: 897
Average Sale per Order: $4.25
Average Sale per Person: $3.23
...
Product Mix: The analysis identifies the top 10 products, helping the shop manage inventory more effectively.
